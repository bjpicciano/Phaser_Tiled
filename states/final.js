...
var debug = true;
game.state.add(states.level3, new Level(this, graphicAssets.level3, getRandomHexColor(), debug));
...
// game.state.add(states.level7, new Level(this, graphicAssets.level4, getRandomHexColor(), debug));
// game.state.add(states.level8, new Level(this, graphicAssets.level4, getRandomHexColor(), debug));
// game.state.add(states.level9, new Level(this, graphicAssets.level4, getRandomHexColor(), debug));
